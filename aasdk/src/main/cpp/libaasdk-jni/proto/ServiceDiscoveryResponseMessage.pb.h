...
class ServiceDiscoveryResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_head_unit_name();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_car_model();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_car_year();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_car_serial();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_headunit_manufacturer();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_headunit_model();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_sw_build();
...
inline ::aasdk::proto::data::ChannelDescriptor* ServiceDiscoveryResponse::add_channels() {
  ::aasdk::proto::data::ChannelDescriptor* _add = _internal_add_channels();
