...
inline void SensorChannelMessage::SharedCtor() {
}
...
inline void SensorChannelMessage::SharedDtor() {
...
void SensorChannelMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<SensorChannelMessage *>(to)->MergeFrom(
      static_cast<const SensorChannelMessage &>(from));
}
