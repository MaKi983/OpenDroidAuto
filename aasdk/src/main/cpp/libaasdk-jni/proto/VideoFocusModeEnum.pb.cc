...
inline void VideoFocusMode::SharedCtor() {
}
...
inline void VideoFocusMode::SharedDtor() {
...
void VideoFocusMode::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<VideoFocusMode *>(to)->MergeFrom(
      static_cast<const VideoFocusMode &>(from));
}
