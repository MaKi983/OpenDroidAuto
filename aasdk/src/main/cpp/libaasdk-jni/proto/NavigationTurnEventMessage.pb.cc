...
void NavigationTurnEvent::SharedCtor() {
street_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
turnimage_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void NavigationTurnEvent::SharedDtor() {
...
void NavigationTurnEvent::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.messages.NavigationTurnEvent)
  GOOGLE_DCHECK_NE(&from, this);
  const NavigationTurnEvent* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<NavigationTurnEvent>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.messages.NavigationTurnEvent)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.messages.NavigationTurnEvent)
    MergeFrom(*source);
  }
}
...
void NavigationTurnEvent::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.messages.NavigationTurnEvent)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
