...
class MediaInfoChannelMetadataData final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_track_name();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_artist_name();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_album_name();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_album_art();
...
inline std::string* MediaInfoChannelMetadataData::mutable_track_name() {
  ...
  return _internal_mutable_track_name();
}
...
inline std::string* MediaInfoChannelMetadataData::mutable_artist_name() {
  ...
  return _internal_mutable_artist_name();
}
...
inline std::string* MediaInfoChannelMetadataData::mutable_album_name() {
  ...
  return _internal_mutable_album_name();
}
...
inline std::string* MediaInfoChannelMetadataData::mutable_album_art() {
  ...
  return _internal_mutable_album_art();
}
