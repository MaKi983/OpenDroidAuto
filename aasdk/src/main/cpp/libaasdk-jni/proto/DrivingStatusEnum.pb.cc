...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.enums.DrivingStatus)
  GOOGLE_DCHECK_NE(&from, this);
  const DrivingStatus* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<DrivingStatus>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.enums.DrivingStatus)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.enums.DrivingStatus)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.enums.DrivingStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
