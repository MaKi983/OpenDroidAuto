...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.data.TouchEvent)
  GOOGLE_DCHECK_NE(&from, this);
  const TouchEvent* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<TouchEvent>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.data.TouchEvent)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.data.TouchEvent)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.data.TouchEvent)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
