...
void NavigationChannelMessage::SharedCtor() {
}
...
void NavigationChannelMessage::SharedDtor() {
...
void NavigationChannelMessage::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.ids.NavigationChannelMessage)
  GOOGLE_DCHECK_NE(&from, this);
  const NavigationChannelMessage* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<NavigationChannelMessage>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.ids.NavigationChannelMessage)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.ids.NavigationChannelMessage)
    MergeFrom(*source);
  }
}
...
void NavigationChannelMessage::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.ids.NavigationChannelMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
