...
PROTOBUF_NAMESPACE_OPEN
template<> ::aasdk::proto::enums::VideoFocusMode* Arena::CreateMaybeMessage<::aasdk::proto::enums::VideoFocusMode>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace aasdk {
namespace proto {
namespace enums {
...
class VideoFocusMode final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:aasdk.proto.enums.VideoFocusMode) */ {
 public:
  inline VideoFocusMode() : VideoFocusMode(nullptr) {}
  ~VideoFocusMode() override;
  explicit constexpr VideoFocusMode(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "aasdk.proto.enums.VideoFocusMode";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:aasdk.proto.enums.VideoFocusMode)
 private:
  class _Internal;
...
template <> struct is_proto_enum< ::aasdk::proto::enums::VideoFocusMode_Enum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::aasdk::proto::enums::VideoFocusMode_Enum>() {
  return ::aasdk::proto::enums::VideoFocusMode_Enum_descriptor();
}
