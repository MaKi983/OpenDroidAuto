...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.enums.SensorType)
  GOOGLE_DCHECK_NE(&from, this);
  const SensorType* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SensorType>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.enums.SensorType)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.enums.SensorType)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.enums.SensorType)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
