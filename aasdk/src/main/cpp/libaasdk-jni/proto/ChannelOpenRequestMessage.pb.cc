...
namespace proto {
namespace messages {
constexpr ChannelOpenRequest::ChannelOpenRequest(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : priority_(0)
  , channel_id_(0){}
struct ChannelOpenRequestDefaultTypeInternal {
  constexpr ChannelOpenRequestDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ChannelOpenRequestDefaultTypeInternal _ChannelOpenRequest_default_instance_;
}  // namespace messages
}  // namespace proto
}  // namespace aasdk
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ChannelOpenRequestMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::ChannelOpenRequest, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::ChannelOpenRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::ChannelOpenRequest, priority_),
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::ChannelOpenRequest, channel_id_),
  0,
  1,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::aasdk::proto::messages::ChannelOpenRequest)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::aasdk::proto::messages::_ChannelOpenRequest_default_instance_),
};

const char descriptor_table_protodef_ChannelOpenRequestMessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\037ChannelOpenRequestMessage.proto\022\024aasdk"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ChannelOpenRequestMessage_2eproto = {
  false, false, 115, descriptor_table_protodef_ChannelOpenRequestMessage_2eproto, "ChannelOpenRequestMessage.proto", 
  ...
  file_level_metadata_ChannelOpenRequestMessage_2eproto, file_level_enum_descriptors_ChannelOpenRequestMessage_2eproto, file_level_service_descriptors_ChannelOpenRequestMessage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_ChannelOpenRequestMessage_2eproto_getter() {
  return &descriptor_table_ChannelOpenRequestMessage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_ChannelOpenRequestMessage_2eproto(&descriptor_table_ChannelOpenRequestMessage_2eproto);
namespace aasdk {
namespace proto {
namespace messages {
...
// @@protoc_insertion_point(message_clear_start:aasdk.proto.messages.ChannelOpenRequest)
...
::PROTOBUF_NAMESPACE_ID::uint8* ChannelOpenRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:aasdk.proto.messages.ChannelOpenRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:aasdk.proto.messages.ChannelOpenRequest)
  return target;
}

size_t ChannelOpenRequest::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:aasdk.proto.messages.ChannelOpenRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:aasdk.proto.messages.ChannelOpenRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_copy_from_start:aasdk.proto.messages.ChannelOpenRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::aasdk::proto::messages::ChannelOpenRequest* Arena::CreateMaybeMessage< ::aasdk::proto::messages::ChannelOpenRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::aasdk::proto::messages::ChannelOpenRequest >(arena);
}
