...
class InputChannel final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::aasdk::proto::data::TouchConfig* release_touch_screen_config();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::aasdk::proto::data::TouchConfig* release_touch_pad_config();
