...
PROTOBUF_NAMESPACE_OPEN
template<> ::aasdk::proto::messages::ChannelOpenResponse* Arena::CreateMaybeMessage<::aasdk::proto::messages::ChannelOpenResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace aasdk {
namespace proto {
namespace messages {
...
class ChannelOpenResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:aasdk.proto.messages.ChannelOpenResponse) */ {
 public:
  inline ChannelOpenResponse() : ChannelOpenResponse(nullptr) {}
  ~ChannelOpenResponse() override;
  explicit constexpr ChannelOpenResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "aasdk.proto.messages.ChannelOpenResponse";
  }
  protected:
