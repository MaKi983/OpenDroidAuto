...
inline void NavigationStatus::SharedCtor() {
status_ = 0;
}
...
inline void NavigationStatus::SharedDtor() {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData NavigationStatus::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    NavigationStatus::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*NavigationStatus::GetClassData() const { return &_class_data_; }

void NavigationStatus::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<NavigationStatus *>(to)->MergeFrom(
      static_cast<const NavigationStatus &>(from));
}
