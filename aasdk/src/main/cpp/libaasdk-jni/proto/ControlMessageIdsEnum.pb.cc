...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.ids.ControlMessage)
  GOOGLE_DCHECK_NE(&from, this);
  const ControlMessage* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ControlMessage>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.ids.ControlMessage)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.ids.ControlMessage)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.ids.ControlMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
