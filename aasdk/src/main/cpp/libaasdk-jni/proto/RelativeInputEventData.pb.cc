...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.data.RelativeInputEvent)
  GOOGLE_DCHECK_NE(&from, this);
  const RelativeInputEvent* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RelativeInputEvent>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.data.RelativeInputEvent)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.data.RelativeInputEvent)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.data.RelativeInputEvent)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
