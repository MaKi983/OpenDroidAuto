...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.ids.AVChannelMessage)
  GOOGLE_DCHECK_NE(&from, this);
  const AVChannelMessage* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<AVChannelMessage>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.ids.AVChannelMessage)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.ids.AVChannelMessage)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.ids.AVChannelMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
