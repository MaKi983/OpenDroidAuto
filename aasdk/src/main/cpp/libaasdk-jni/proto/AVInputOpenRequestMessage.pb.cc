...
void AVInputOpenRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<AVInputOpenRequest *>(to)->MergeFrom(
      static_cast<const AVInputOpenRequest &>(from));
}
