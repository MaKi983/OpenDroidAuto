...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ChannelOpenResponseMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::ChannelOpenResponse, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::ChannelOpenResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::ChannelOpenResponse, status_),
  0,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(::aasdk::proto::messages::ChannelOpenResponse)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::aasdk::proto::messages::_ChannelOpenResponse_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ChannelOpenResponseMessage_2eproto = {
  false, false, 145, descriptor_table_protodef_ChannelOpenResponseMessage_2eproto, "ChannelOpenResponseMessage.proto", 
...
ChannelOpenResponse::ChannelOpenResponse(const ChannelOpenResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:aasdk.proto.messages.ChannelOpenResponse)
}
...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.messages.ChannelOpenResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const ChannelOpenResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ChannelOpenResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.messages.ChannelOpenResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.messages.ChannelOpenResponse)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.messages.ChannelOpenResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::aasdk::proto::messages::ChannelOpenResponse* Arena::CreateMaybeMessage< ::aasdk::proto::messages::ChannelOpenResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::aasdk::proto::messages::ChannelOpenResponse >(arena);
}
