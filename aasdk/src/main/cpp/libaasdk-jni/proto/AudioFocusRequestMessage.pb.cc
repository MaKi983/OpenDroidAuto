...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.messages.AudioFocusRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const AudioFocusRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<AudioFocusRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.messages.AudioFocusRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.messages.AudioFocusRequest)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.messages.AudioFocusRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
