...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.enums.VideoResolution)
  GOOGLE_DCHECK_NE(&from, this);
  const VideoResolution* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<VideoResolution>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.enums.VideoResolution)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.enums.VideoResolution)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.enums.VideoResolution)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
