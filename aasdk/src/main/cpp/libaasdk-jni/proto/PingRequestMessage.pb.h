...
PROTOBUF_NAMESPACE_OPEN
template<> ::aasdk::proto::messages::PingRequest* Arena::CreateMaybeMessage<::aasdk::proto::messages::PingRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace aasdk {
namespace proto {
namespace messages {
...
class PingRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:aasdk.proto.messages.PingRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "aasdk.proto.messages.PingRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:aasdk.proto.messages.PingRequest)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 PingRequest::timestamp() const {
  // @@protoc_insertion_point(field_get:aasdk.proto.messages.PingRequest.timestamp)
...
inline void PingRequest::set_timestamp(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:aasdk.proto.messages.PingRequest.timestamp)
}
