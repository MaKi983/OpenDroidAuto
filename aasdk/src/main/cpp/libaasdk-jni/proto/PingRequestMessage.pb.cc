...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_PingRequestMessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::PingRequest, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::PingRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::messages::PingRequest, timestamp_),
  0,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(::aasdk::proto::messages::PingRequest)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::aasdk::proto::messages::_PingRequest_default_instance_),
};

const char descriptor_table_protodef_PingRequestMessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\030PingRequestMessage.proto\022\024aasdk.proto."
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PingRequestMessage_2eproto = {
  false, false, 82, descriptor_table_protodef_PingRequestMessage_2eproto, "PingRequestMessage.proto", 
...
PingRequest::PingRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:aasdk.proto.messages.PingRequest)
}
PingRequest::PingRequest(const PingRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:aasdk.proto.messages.PingRequest)
}
...
PingRequest::~PingRequest() {
  // @@protoc_insertion_point(destructor:aasdk.proto.messages.PingRequest)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:aasdk.proto.messages.PingRequest)
...
::PROTOBUF_NAMESPACE_ID::uint8* PingRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:aasdk.proto.messages.PingRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:aasdk.proto.messages.PingRequest)
  return target;
}

size_t PingRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:aasdk.proto.messages.PingRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.messages.PingRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const PingRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PingRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.messages.PingRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.messages.PingRequest)
    MergeFrom(*source);
  }
}

void PingRequest::MergeFrom(const PingRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:aasdk.proto.messages.PingRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.messages.PingRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:aasdk.proto.messages.PingRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::aasdk::proto::messages::PingRequest* Arena::CreateMaybeMessage< ::aasdk::proto::messages::PingRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::aasdk::proto::messages::PingRequest >(arena);
}
