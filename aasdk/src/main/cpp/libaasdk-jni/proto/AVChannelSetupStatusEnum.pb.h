...
PROTOBUF_NAMESPACE_OPEN
template<> ::aasdk::proto::enums::AVChannelSetupStatus* Arena::CreateMaybeMessage<::aasdk::proto::enums::AVChannelSetupStatus>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace aasdk {
namespace proto {
namespace enums {
...
class AVChannelSetupStatus final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:aasdk.proto.enums.AVChannelSetupStatus) */ {
 public:
  inline AVChannelSetupStatus() : AVChannelSetupStatus(nullptr) {}
  ~AVChannelSetupStatus() override;
  explicit constexpr AVChannelSetupStatus(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline AVChannelSetupStatus* New() const final {
    return new AVChannelSetupStatus();
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "aasdk.proto.enums.AVChannelSetupStatus";
  }
  protected:
...
template <> struct is_proto_enum< ::aasdk::proto::enums::AVChannelSetupStatus_Enum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::aasdk::proto::enums::AVChannelSetupStatus_Enum>() {
