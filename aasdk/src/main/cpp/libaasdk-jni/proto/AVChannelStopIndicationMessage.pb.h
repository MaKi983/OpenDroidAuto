...
PROTOBUF_NAMESPACE_OPEN
template<> ::aasdk::proto::messages::AVChannelStopIndication* Arena::CreateMaybeMessage<::aasdk::proto::messages::AVChannelStopIndication>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace aasdk {
namespace proto {
namespace messages {
...
class AVChannelStopIndication final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:aasdk.proto.messages.AVChannelStopIndication) */ {
 public:
  inline AVChannelStopIndication() : AVChannelStopIndication(nullptr) {}
  ~AVChannelStopIndication() override;
  explicit constexpr AVChannelStopIndication(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline AVChannelStopIndication* New() const final {
    return new AVChannelStopIndication();
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "aasdk.proto.messages.AVChannelStopIndication";
  }
  protected:
