...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_NightModeData_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::data::NightMode, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::data::NightMode, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::data::NightMode, is_night_),
  0,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(::aasdk::proto::data::NightMode)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::aasdk::proto::data::_NightMode_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_NightModeData_2eproto = {
  false, false, 70, descriptor_table_protodef_NightModeData_2eproto, "NightModeData.proto", 
...
NightMode::NightMode(const NightMode& from)
  ...
  // @@protoc_insertion_point(copy_constructor:aasdk.proto.data.NightMode)
}
...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.data.NightMode)
  GOOGLE_DCHECK_NE(&from, this);
  const NightMode* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<NightMode>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.data.NightMode)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.data.NightMode)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.data.NightMode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::aasdk::proto::data::NightMode* Arena::CreateMaybeMessage< ::aasdk::proto::data::NightMode >(Arena* arena) {
  return Arena::CreateMessageInternal< ::aasdk::proto::data::NightMode >(arena);
}
