...
// @@protoc_insertion_point(generalized_merge_from_start:aasdk.proto.data.TouchConfig)
  GOOGLE_DCHECK_NE(&from, this);
  const TouchConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<TouchConfig>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:aasdk.proto.data.TouchConfig)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:aasdk.proto.data.TouchConfig)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:aasdk.proto.data.TouchConfig)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
