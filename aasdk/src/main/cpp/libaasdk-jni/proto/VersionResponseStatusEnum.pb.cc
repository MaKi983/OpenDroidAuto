...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_VersionResponseStatusEnum_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::aasdk::proto::enums::VersionResponseStatus, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::aasdk::proto::enums::VersionResponseStatus)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::aasdk::proto::enums::_VersionResponseStatus_default_instance_),
};

const char descriptor_table_protodef_VersionResponseStatusEnum_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\037VersionResponseStatusEnum.proto\022\021aasdk"
  ".proto.enums\":\n\025VersionResponseStatus\"!\n"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_VersionResponseStatusEnum_2eproto = {
  false, false, 112, descriptor_table_protodef_VersionResponseStatusEnum_2eproto, "VersionResponseStatusEnum.proto", 
...
// @@protoc_insertion_point(message_clear_start:aasdk.proto.enums.VersionResponseStatus)
...
::PROTOBUF_NAMESPACE_ID::uint8* VersionResponseStatus::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:aasdk.proto.enums.VersionResponseStatus)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:aasdk.proto.enums.VersionResponseStatus)
  return target;
}

size_t VersionResponseStatus::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:aasdk.proto.enums.VersionResponseStatus)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_copy_from_start:aasdk.proto.enums.VersionResponseStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::aasdk::proto::enums::VersionResponseStatus* Arena::CreateMaybeMessage< ::aasdk::proto::enums::VersionResponseStatus >(Arena* arena) {
  return Arena::CreateMessageInternal< ::aasdk::proto::enums::VersionResponseStatus >(arena);
}
